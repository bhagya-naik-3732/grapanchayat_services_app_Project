...
import com.ayeshabhagya.grampanchayat.databinding.FragmentResolvedComplaintsBinding;

import java.util.ArrayList;
import java.util.List;

public class ResolvedComplaintsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        readResolvedComplaints();

        return view;
    }


    public void readResolvedComplaints() {
