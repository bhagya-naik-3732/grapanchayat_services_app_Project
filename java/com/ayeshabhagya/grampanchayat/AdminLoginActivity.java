...
package com.ayeshabhagya.grampanchayat;
...
public class AdminLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_login.setOnClickListener(v -> {
            ...
            if (ID.equals("bhagyanaik02@gmail.com") && Password.equals("hello@1234")) {

                // Signing in with the entered credentials
                auth.signInWithEmailAndPassword("bhagyanaik02@gmail.com", "hello@1234")
